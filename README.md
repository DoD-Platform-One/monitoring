...
| grafana.image.tag | string | `"12.0.1"` |  |
...
| prometheusOperator.kubectlImage.tag | string | `"v1.32.5"` |  |
...
| prometheus.prometheusSpec.image.tag | string | `"v3.4.1"` |  |
