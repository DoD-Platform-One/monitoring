...
| grafana.image.tag | string | `"11.4.0"` |  |
...
| prometheusOperator.image.tag | string | `"v0.79.2"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.79.2"` |  |
...
| prometheusOperator.thanosImage.tag | string | `"v0.37.2"` |  |
