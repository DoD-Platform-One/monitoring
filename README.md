...
![Version: 30.0.1-bb.7](https://img.shields.io/badge/Version-30.0.1--bb.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.53.1](https://img.shields.io/badge/AppVersion-0.53.1-informational?style=flat-square)
...
| grafana.image.tag | string | `"8.3.3"` |  |
...
| grafana.sidecar.image.tag | string | `"1.15.0"` |  |
...
| prometheusOperator.image.tag | string | `"v0.53.1"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.53.1"` |  |
...
| prometheus.prometheusSpec.image.tag | string | `"v2.32.1"` |  |
