...
![Version: 23.1.6-bb.7](https://img.shields.io/badge/Version-23.1.6--bb.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.52.1](https://img.shields.io/badge/AppVersion-0.52.1-informational?style=flat-square)
...
| grafana.image.tag | string | `"8.3.1"` |  |
...
| grafana.sidecar.image.tag | string | `"1.14.2"` |  |
...
| grafana.downloadDashboardsImage.tag | float | `8.4` |  |
...
| kubeStateMetrics.serviceMonitor.honorLabels | bool | `true` |  |
...
| kube-state-metrics.image.tag | string | `"v2.2.4"` |  |
...
| nodeExporter.serviceMonitor.proxyUrl | string | `""` |  |
...
| prometheus-node-exporter.image.tag | string | `"v1.2.2"` |  |
...
| prometheusOperator.admissionWebhooks.cleanupProxy.image.tag | float | `8.4` |  |
...
| prometheusOperator.image.tag | string | `"v0.52.1"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.52.1"` |  |
...
| prometheusOperator.thanosImage.tag | string | `"v0.23.1"` |  |
...
| prometheus.prometheusSpec.image.tag | string | `"v2.31.1"` |  |
