...
![Version: 43.1.2-bb.3](https://img.shields.io/badge/Version-43.1.2--bb.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.61.1](https://img.shields.io/badge/AppVersion-0.61.1-informational?style=flat-square)
...
| alertmanager.alertmanagerSpec.image.tag | string | `"v0.24.0"` |  |
...
| grafana.image.tag | string | `"9.3.2"` |  |
...
| grafana.sidecar.image.tag | string | `"1.21.0"` |  |
...
| grafana.initChownData.image.tag | string | `"8.7"` |  |
...
| kube-state-metrics.image.tag | string | `"v2.7.0"` |  |
...
| prometheusOperator.image.tag | string | `"v0.61.1"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.61.1"` |  |
...
| prometheusOperator.thanosImage.tag | string | `"v0.29.0"` |  |
...
| prometheusOperator.kubectlImage.tag | string | `"v1.25.5"` |  |
...
| prometheus.prometheusSpec.image.tag | string | `"v2.40.5"` |  |
...
Please see the [contributing guide](./CONTRIBUTING.md) if you are interested in contributing. # kube-prometheus-stack
...
|------------|------|---------|
| https://grafana.github.io/helm-charts | grafana | 6.48.* |
| https://prometheus-community.github.io/helm-charts | kube-state-metrics | 4.24.* |
