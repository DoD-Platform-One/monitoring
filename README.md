...
![Version: 45.27.2-bb.4](https://img.shields.io/badge/Version-45.27.2--bb.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.65.1](https://img.shields.io/badge/AppVersion-0.65.1-informational?style=flat-square)
...
| alertmanager.alertmanagerSpec.image.tag | string | `"v0.25.0"` |  |
...
| grafana.image.tag | string | `"9.5.1"` |  |
...
| grafana.sidecar.image.tag | string | `"1.23.3"` |  |
...
| prometheusOperator.admissionWebhooks.failurePolicy | string | `nil` |  |
...
| prometheusOperator.image.tag | string | `"v0.65.1"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.65.1"` |  |
...
| prometheusOperator.thanosImage.tag | string | `"v0.30.2"` |  |
...
| prometheusOperator.kubectlImage.tag | string | `"v1.26.4"` |  |
...
| prometheus.prometheusSpec.image.tag | string | `"v2.42.0"` |  |
...
| thanosRuler.thanosRulerSpec.image.tag | string | `"v0.30.2"` |  |
