...
![Version: 34.8.0-bb.1](https://img.shields.io/badge/Version-34.8.0--bb.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.55.0](https://img.shields.io/badge/AppVersion-0.55.0-informational?style=flat-square)
...
|------------|------|---------|
| https://grafana.github.io/helm-charts | grafana | 6.24.* |
| https://prometheus-community.github.io/helm-charts | kube-state-metrics | 4.7.* |
| https://prometheus-community.github.io/helm-charts | prometheus-node-exporter(prometheus-node-exporter) | 3.1.* |
...
| cleanUpgrade.image.tag | string | `"1.0.0"` |  |
...
| grafana.image.tag | string | `"8.4.4"` |  |
...
| grafana.sidecar.image.tag | string | `"1.15.9"` |  |
...
| prometheusOperator.image.tag | string | `"v0.55.1"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.55.0"` |  |
...
| prometheus.prometheusSpec.image.tag | string | `"v2.34.0"` |  |
