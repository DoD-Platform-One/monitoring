...
![Version: 40.4.0-bb.0](https://img.shields.io/badge/Version-40.4.0--bb.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.59.2](https://img.shields.io/badge/AppVersion-v0.59.2-informational?style=flat-square)
...
| grafana.image.tag | string | `"9.1.6"` |  |
...
| grafana.sidecar.image.tag | string | `"1.19.5"` |  |
...
| grafana.initChownData.image.tag | string | `"8.6"` |  |
...
| kube-state-metrics.image.tag | string | `"v2.6.0"` |  |
...
| prometheus-node-exporter.image.tag | string | `"v1.4.0"` |  |
...
| prometheusOperator.image.tag | string | `"v0.59.2"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.59.2"` |  |
...
| prometheusOperator.thanosImage.tag | string | `"v0.28.0"` |  |
...
| prometheusOperator.kubectlImage.tag | string | `"v1.25.2"` |  |
...
| prometheus.prometheusSpec.image.tag | string | `"v2.39.0"` |  |
...
| thanosRuler.thanosRulerSpec.image.tag | string | `"v0.28.0"` |  |
