...
![Version: 35.2.0-bb.3](https://img.shields.io/badge/Version-35.2.0--bb.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.56.2](https://img.shields.io/badge/AppVersion-0.56.2-informational?style=flat-square)
...
| prometheusOperator.image.tag | string | `"v0.56.2"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.56.2"` |  |
