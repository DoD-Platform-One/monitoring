...
![Version: 47.1.0-bb.3](https://img.shields.io/badge/Version-47.1.0--bb.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.66.0](https://img.shields.io/badge/AppVersion-v0.66.0-informational?style=flat-square)
...
| grafana.sidecar.image.tag | string | `"1.24.4"` |  |
...
| grafana.initChownData.image.tag | string | `"8.8"` |  |
...
| prometheus-node-exporter.image.tag | string | `"v1.6.0"` |  |
...
| prometheusOperator.image.tag | string | `"v0.66.0"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.66.0"` |  |
...
| prometheusOperator.kubectlImage.tag | string | `"1.27.3"` |  |
