...
![Version: 56.2.1-bb.10](https://img.shields.io/badge/Version-56.2.1--bb.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.71.2](https://img.shields.io/badge/AppVersion-v0.71.2-informational?style=flat-square)
...
| prometheusOperator.image.tag | string | `"v0.71.2"` |  |
...
| prometheusOperator.prometheusConfigReloader.image.tag | string | `"v0.71.2"` |  |
