...
The image was being pulled from quay.io/prometheus/alertmanager:v0.18.0.  There was no hardened container so the image was moved to registry.dso.mil/platform-one/apps/monitoring/alertmanager:0.18.0.  This has an open issue to harden.
